...
namespace FinBotNet
{
    ...
    public class VIDYA
    {
        ...
        {
            var indicator = Indicators.IndicatorsDefinition["vidya"];
            var count = indicator.Start(new decimal[] {ShortPeriod, LongPeriod, Alpha});
            ...
            indicator.Run(input, new decimal[] {ShortPeriod, LongPeriod, Alpha}, output);
